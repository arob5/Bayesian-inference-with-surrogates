...
prior_post_plots <- get_1d_kde_plots(samp_dt_comb, test_label_baseline="prior",
                                     bandwidth_mult=1.5, line_thickness=2.0)

for(i in seq_along(prior_post_plots)) {
  plt <- ggformat_journal(prior_post_plots[[i]], remove_title=TRUE) + labs(y="density")
