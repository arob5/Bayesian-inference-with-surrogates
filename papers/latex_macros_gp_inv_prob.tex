...
\newcommand{\normCstEm}[1][\Ndesign]{\normCst_{#1}}
\newcommand{\postApproxEP}[1][\Ndesign]{\postDensNorm_{#1}^{\textrm{EP}}}
\newcommand{\postApproxMean}[1][\Ndesign]{\postDens_{#1}^{\textrm{mean}}}
\newcommand{\postApproxMarg}[1][\Ndesign]{\postDens_{#1}^{\textrm{EL}}}
\newcommand{\postApproxNormMarg}[1][\Ndesign]{\postDensNorm_{#1}^{\textrm{EL}}}
...
\newcommand{\llikEmSampDensNorm}[1][\Ndesign]{\llikEmRdm[#1]{\postDensNorm}^{\textrm{EP}}}
...
\newcommand{\NMCMC}{\NSample_{\text{MCMC}}} % Proposal covariance matrix
