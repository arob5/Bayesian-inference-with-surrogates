...
in regions with high surrogate uncertainty. At two points with equal predictive mean $\gpMean$, the 
EUP always assigns higher density to the more uncertain location. Notably, the magnitude of the
