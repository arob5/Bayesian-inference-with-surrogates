...
We now consider an alternative approach: implicitly defining an EP approximation by 
considering targeted approximations to MCMC algorithms. We demonstrate that this 
approximate computation approach often leads to better approximations. We also 
highlight 
