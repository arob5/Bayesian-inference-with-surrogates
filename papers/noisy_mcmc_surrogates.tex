...
While both the EP and EUP propagate the surrogate uncertainty in this example, their qualitative behavior is markedly 
different as the magnitude of the surrogate variance increases. From \Cref{eq:lin-gaussi-ep}, we see that the EP
is a mixture of linear Gaussian posteriors, each with covariance $\postCov$. The posterior inflation thus 

The EP represents an infinite Gaussian mixture of linear Gaussian posteriors, each with 


while the EUP is the posterior
