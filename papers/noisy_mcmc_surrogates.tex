...
quality of the rk-pcn approximation to the EP.
...
the special case $\noiseCov = \sigma^2 I$, $\priorCov = c_0^2 I$, $\emCov = qI$. The following results give
...
In the non-asymptotic regime, the surrogate uncertainty inflates both $\postMeanEUP$ and $\postMeanEP$
mosts significantly along directions well-informed by the data ($v_j$ with $s_j$ large). 
...
\subsubsection{A Deconvolution Problem}
