...
Other lines of research instead choose $\target$ to be the map induced by the log-likelihood
...
the global point estimate $\emE[\normCst(\targetEm)]$. Like the EP, the EUP admits
...
written as the posterior mixture
\begin{equation}
...
\todo{Need to clarify this point}
