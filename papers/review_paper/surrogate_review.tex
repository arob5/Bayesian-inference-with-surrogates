...
Let $\emE$ denote the expectation with respect to the predictive distribution, and $\emMean(\Par) \Def \emE[\targetEm(\Par)]$,
$\emVar(\Par) \Def \Var_{\emDist}[\targetEm(\Par)]$ denote the pointwise predictive mean and variance, respectively.
