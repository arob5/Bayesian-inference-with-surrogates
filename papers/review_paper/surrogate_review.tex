...
\begin{figure}
     ...
     \begin{subfigure}[b]{0.48\textwidth} % post norm approx [ldens] 
         ...
         \caption{$\postDensNorm$ approx}
         \label{fig:post_norm_approx_ldensem}
     \end{subfigure}
...
one at a time. This allows for the most informed selection of the points, but fails to exploit parallel computing 
