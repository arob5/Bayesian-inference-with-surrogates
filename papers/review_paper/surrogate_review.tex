...
\nonumber
\end{align}
Thus, in their most basic form GPs surrogates are Gaussian predictors 
...
a polynomial basis is used to approximate a random variable $\func(\Par)$ as a function of
