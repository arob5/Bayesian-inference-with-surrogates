...
$\dimObs$-dimensional observable quantity. Assume the observations are generated as 
\begin{align}
...
inverse problem framework with forward model $\fwd \Def \obsOp \circ \solutionOp$. In this case, the computational
