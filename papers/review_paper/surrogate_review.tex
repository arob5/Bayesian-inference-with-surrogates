...
$\emE[\postEm(\Par)]$ is available in closed-form (see \Cref{eup-fwd-em,eup-ldens-em}), 
...
extreme concentration in small regions with large uncertainty \Cref{ourSurrPropPaper,VehtariParallelGP}.
\end{examplebox}
