...
\newcommand{\emMean}{\mu_\Ndesign}
\newcommand{\emVar}{s^2_\Ndesign}
\newcommand{\emDist}{\nu_{\Ndesign}} % Predictive distribution (law) of the emulator (a stochastic process)
