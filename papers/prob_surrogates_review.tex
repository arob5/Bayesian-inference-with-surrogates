...
$\gamma \sim \mathrm{law}(\funcEm[\Ndesign](\parMat))$. The ECU therefore implies averaging over 
...
conditional on $\gamma$. Here, $\weightDens$ is a measure on $\Par$ that we are free to choose.
