...
This section proves \Cref{prop:fwd-em-Gaussian,prop:llik-em-Gaussian}, which characterize the distribution 
...
\Cref{prop:fwd-em-Gaussian} follows directly from the following result.
