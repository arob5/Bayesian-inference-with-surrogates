...
replacing $\accProbMH(\Par, \propPar)$. Table [\todo] compares the E-Acc approximation
to the alternative approximations of $\accProbMH(\Par, \propPar)$ that are implicitly 
induced by approximations of the unnormalized posterior density. 
\citet{surrogateNoisyMCMC} propose the E-Acc algorithm, 
and explore connections to the expected posterior approximation in in \Cref{alg:ep}.
