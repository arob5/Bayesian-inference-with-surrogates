...
Various papers remark that accurate approximation requires design points only in the region where the 
...
Various versions of this tradeoff have been articulated
across several studies 
\citep{StuartTeck2, gp_surrogates_random_exploration,emPostDens,SinsbeckNowak,Surer2023sequential,adaptiveMultimodal}.

The success of a sequential design strategy is also dictated by the posterior geometry and the emulator
being used. For example, \citet{adaptiveMultimodal} propose an active learning algorithm targeting multimodal 
posteriors. Another promising line of research consists of adapting local approximations, avoiding the challenging
task of fitting a global surrogate \citep{Li_2014,ConradLocalExactMCMC}. 
...
the batch sequential design setting, where multiple design points are acquired simultaneously.
...
The unnormalized density value $\postEm[\Ndesign](\Par)$ may have wide prediction 
intervals, but 
