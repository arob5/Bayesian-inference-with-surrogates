...
broader computer experiments literature. Our aim is not to investigate any specific 
...
[\todo: cite Istem here, and garegnani2021NoisyMCMC]
...
introduced above are well-defined. Consideration of this theoretical technicality points to important 
practical issues in constructing emulators for use in posterior approximation. The primary concern
...
decays sufficiently quickly as $\norm{\Par} \to \infty$. From a practical perspective, our general 
...
the predictive distribution at sequences of points along the coordinate axes. 
...
scheme, while in the other articles the coefficients are learned alongside the kernel hyperparameters.
Various works have also proposed combining polynomial chaos expansions and 
Gaussian processes (\todo: cite).
...
Wilkinson (2014); Gutmann and Corander (2016); Drovandi et al. (2018),
