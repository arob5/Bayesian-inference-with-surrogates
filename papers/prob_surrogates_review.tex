...
design algorithms to iteratively construct the design in order to target high-posterior regions (see \Cref{sec:seq_design}).
...
as we cannot construct $\postEm[\Naugment]$ without observing the response $\func(\parMat)$. We therefore
