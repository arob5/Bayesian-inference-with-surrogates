...
\begin{figure}
     ...
     \end{subfigure}
        \caption{Marginal prior (black dashed) and posterior (red) distributions for the four
...
\begin{figure}
     ...
     \end{subfigure}
        ...
        line is ground truth LAI trajectory used to generate the data. (Right) The analogous plot
