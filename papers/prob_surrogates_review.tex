...
We will now consider replacing $\acceptProbMH(\Par, \propPar)$ with a surrogate-induced approximation.
...
$\E_{\Ndesign}\left[\accProbMHEm[\Ndesign](\Par, \propPar)\right]$. A practical algorithm is given in 
\cref{alg:MH-noisy}, which proceeds by drawing a sample of $\accProbMHEm[\Ndesign](\Par, \propPar)$ at
 ...
 or the requirement to approximate infinite-dimensional sample trajectories. 
