...
Consider the setting in \cref{eq:fwd-em-Gaussian}, where both the forward model emulator 
...
Consider the setting in \cref{eq:llik-em-Gaussian} with a Gaussian log-likelihood emulator. The 
