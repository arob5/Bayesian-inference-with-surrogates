...
Irrespective of the particular target, an underlying probabilistic surrogate will 
induce random approximations of the log-likelihood, log-posterior, and posterior.
...
$\llikEm[\Ndesign](\Par) = \llik(\Par; \fwdEm[\Ndesign])$, and similarly for the
log-posterior and posterior.
...
under the joint posterior $p(\Par, \fwdEm[\Ndesign] \given \obs)$.
