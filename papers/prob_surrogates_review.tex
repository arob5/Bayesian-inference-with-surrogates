...
The log-likelihood emulation approach is considered in \citet{VehtariParallelGP,FATES_CES,trainDynamics,quantileApprox,ActiveLearningMCMC,FerEmulation}.
...
\subsubsection{Log-Likelihood vs. Unnormalized Log-Posterior Density Emulation}
