...
design literature, which focuses on the behavior of single-point acquisition algorithms as $\Nbatch$ grows large.
We start by highlighting batch methods borrowed from the broader active learning and Bayesian optimization 
literature, and then discuss some promising approaches well-suited to the goal of posterior approximation.
