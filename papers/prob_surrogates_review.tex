...
and those naturally defined in the batch setting. \Cref{sec:batch-heuristic} discusses 
...
The choice $\weightDens \in \{\priorDens, \postDens\}$ determines whether error is assessed with
