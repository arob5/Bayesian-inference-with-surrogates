...
\footnote{This is in contrast to other surrogate modeling strategies (e.g., reduced-order modeling) for $\fwd$ 
...
model the latter as \textit{log-likelihood emulation}.
...
form \ref{ode_inv_prob} motivated by problems in near-term carbon cycle forecasting and 
...
and results in a non-Gaussian predictive distribution. 
