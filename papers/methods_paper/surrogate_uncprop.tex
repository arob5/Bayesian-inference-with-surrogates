...
more uncertain location. Notably, the magnitude of the
uncertainty inflation scales with the exponentiated predictive variance, potentially leading to extreme 
concentration in the most uncertain regions. For example, if $\emSD(\Par) = 2$,
...
Bayesian inference. Robust log-density emulation.
