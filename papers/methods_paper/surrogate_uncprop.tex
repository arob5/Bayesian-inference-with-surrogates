...
$\target$, $\emDist$ can be the pushforward of an underlying Gaussian measure.} We focus on this setting due to the 
fact that EP-based inference is challenged by 
