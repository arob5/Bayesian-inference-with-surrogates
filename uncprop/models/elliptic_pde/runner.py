...
run_kwargs = {
    'mcmc_settings': {'n_samples': 100_000, 'n_burnin': 0, 
                      'thin_window': 1, 'adapt_kwargs': {'gamma_exponent': 0.5}}, # 0.4
    'mcwmh_settings': {'n_chains': 10, 'n_samp_per_chain': 10, 
                       'n_burnin': 10_000, 'thin_window': 1000,
                       'adapt_kwargs': None}
}
